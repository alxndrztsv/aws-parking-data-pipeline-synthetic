...
<p align="center">
  <a href="https://raw.githubusercontent.com/alxndrztsv/aws-parking-data-pipeline-synthetic/main/docs/architecture.png" target="_blank">
...
<details>
  ...
  <br>
  <p align="center">
    <a href="https://raw.githubusercontent.com/alxndrztsv/aws-parking-data-pipeline-synthetic/main/docs/s3.png" target="_blank">
      <img src="docs/s3.png" alt="S3 Buckets" width="1024"/>
    </a>
    <br>
    <em>Figure 2: Raw CSVs in Bronze, processed CSVs in Silver, and aggregated report-ready CSV in Gold.</em>
  </p>
</details>
...
<table>
  ...
  <tr>
    <td>
      <a href="https://raw.githubusercontent.com/alxndrztsv/aws-parking-data-pipeline-synthetic/main/docs/step-functions-success.png" target="_blank">
        <img src="docs/step-functions-success.png" alt="Success" width="100%"/>
      </a>
    </td>
    <td>
      <a href="https://raw.githubusercontent.com/alxndrztsv/aws-parking-data-pipeline-synthetic/main/docs/step-functions-failure.png" target="_blank">
        <img src="docs/step-functions-failure.png" alt="Failure" width="100%"/>
      </a>
    </td>
  </tr>
  <tr>
    <td><em>Figure 3: Successful Step Functions execution resulting in a report email.</em></td>
    <td><em>Figure 4: Failed Step Functions execution triggering an email alert.</em></td>
  </tr>
</table>
...
<details>
  ...
  <br>
  <p align="center">
    <a href="https://raw.githubusercontent.com/alxndrztsv/aws-parking-data-pipeline-synthetic/main/docs/glue-schema.png" target="_blank">
      <img src="docs/glue-schema.png" alt="Glue Silver table schema" width="602"/>
    </a>
    <br>
    <em>Figure 5: Glue Silver table contains 26 processed columns.</em>
  </p>
</details>
...
<details>
  ...
  <br>
  <p align="center">
    <a href="https://raw.githubusercontent.com/alxndrztsv/aws-parking-data-pipeline-synthetic/main/docs/dbt-fact-daily-analysis.png" target="_blank">
      <img src="docs/dbt-fact-daily-analysis.png" alt="Fact daily analysis" width="1024"/>
    </a>
    <br>
    <em>Figure 6: Payment analysis fact table.</em>
  </p>
</details>
...
<details>
  ...
  <br>
  <p align="center">
    <a href="https://raw.githubusercontent.com/alxndrztsv/aws-parking-data-pipeline-synthetic/main/docs/dbt-lineage-graph.png" target="_blank">
      <img src="docs/dbt-lineage-graph.png" alt="dbt Lineage graph" width="1024"/>
    </a>
    <br>
    <em>Figure 7: dbt Lineage graph generated by dbt docs.</em>
  </p>
</details>
...
<table>
  ...
  <tr>
    <td>
    <a href="https://raw.githubusercontent.com/alxndrztsv/aws-parking-data-pipeline-synthetic/main/docs/email-report.png" target="_blank">
      <img src="docs/email-report.png" alt="Report" width="100%"/>
    </a>
    </td>
    <td>
    <a href="https://raw.githubusercontent.com/alxndrztsv/aws-parking-data-pipeline-synthetic/main/docs/email-alert.png" target="_blank">
      <img src="docs/email-alert.png" alt="Alert" width="100%"/>
    </a>
    </td>
  </tr>
  <tr>
    <td><em>Figure 8: HTML report generated by the Lambda function.</em></td>
    <td><em>Figure 9: Alert triggered by the EventBridge failure rule.</em></td>
  </tr>
</table>
